...
const Canvas = () => {
  ...
  return (
    <div className="w-screen">
      <div className="flex justify-between bg-slate-950 fixed w-screen top-0 left-0">
          ...
          <div className='flex justify-between mr-2 p-2 my-auto'>
            <div className='mr-4'>
                <button onClick={()=>{ router.push('https://github.com/adityaChauhan2510') }}>
                    <GithubIcon></GithubIcon>
                </button>
                
            </div>
            <div className='mr-4'>
                <button onClick={()=>{ router.push('https://www.linkedin.com/in/adityachauhan25/') }}>
